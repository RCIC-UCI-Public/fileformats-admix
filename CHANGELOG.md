...
## [Unreleased](https://github.com/RCIC-UCI-Public/fileformats-admix/compare/2.5...HEAD)

### Commits

- update copyright [`3bcfc88`](https://github.com/RCIC-UCI-Public/fileformats-admix/commit/3bcfc88f01ed59bb58a2f70f5e03b35e7f9f3ca9)
- use actual rpm size [`f84e83b`](https://github.com/RCIC-UCI-Public/fileformats-admix/commit/f84e83b65cd787dade06846e6e99998f1ee032c6)
- update rmpdb [`a40c7bb`](https://github.com/RCIC-UCI-Public/fileformats-admix/commit/a40c7bb30173a32a35b05b83fc71cd8c35b7029a)
- rename set-2026-base and versions-2026-base as 2026-gccsys [`0818126`](https://github.com/RCIC-UCI-Public/fileformats-admix/commit/0818126355e92b9409ef517e3c0f3fb076f0f3e1)
- HDF5 developers changed flag for enabling zlib support from [`4baddb4`](https://github.com/RCIC-UCI-Public/fileformats-admix/commit/4baddb44a3b689ded456846e6bcfa71d8a6ad2de)
- add hdf5 latest version compilation with system gcc. [`e886fdb`](https://github.com/RCIC-UCI-Public/fileformats-admix/commit/e886fdb4e82086e2fe11d0477d11b7ff295f4337)
- Add additional cmake  config option for compiling parallel hdf5 in [`e7aea67`](https://github.com/RCIC-UCI-Public/fileformats-admix/commit/e7aea67091ea062fe8a01a127514fa8b129e90d5)
- add set-2026 with hdf5 v 2.0.0 and udunits 2.2.28 [`632286c`](https://github.com/RCIC-UCI-Public/fileformats-admix/commit/632286c38602c3da36c192e29bd4c5ecae7496e7)
- hdf5 had a major update form v1 to v2. New  source  tarball has [`2e5e81e`](https://github.com/RCIC-UCI-Public/fileformats-admix/commit/2e5e81e5aa5327608e77357cd859f48934a2b0cb)
- update rpmdb for rocky 9.7 [`196fdce`](https://github.com/RCIC-UCI-Public/fileformats-admix/commit/196fdce023d21d4c886438250c5696006ea70bd5)
- add admix expected rpms sizes [`8fb105d`](https://github.com/RCIC-UCI-Public/fileformats-admix/commit/8fb105d0076db1cc315d57afd7ee74dfc97bc147)
- ignore build stage directories [`9230404`](https://github.com/RCIC-UCI-Public/fileformats-admix/commit/923040497bdc39b8cf12637ef5fa68327e035b31)
- The first statement of the description shdold [`7a315b6`](https://github.com/RCIC-UCI-Public/fileformats-admix/commit/7a315b65ac6c1e6e476d1171ac580a9df6d56da1)
- restore ioapi for workling intel version. This will be a fallback [`8527963`](https://github.com/RCIC-UCI-Public/fileformats-admix/commit/85279635ce2da573e28da25696a087b4b304c9a3)
- dont build ioapi, unused [`ef1f64e`](https://github.com/RCIC-UCI-Public/fileformats-admix/commit/ef1f64e8e1fe77b21223061b5b38325064a496dd)
- Dont build unused nco/5.0.6/gcc.11.2.0 and [`98e6f63`](https://github.com/RCIC-UCI-Public/fileformats-admix/commit/98e6f6372493ce392b6bde459096044a1237e1db)
- For parallel build, can't remove versions.yaml -- set to the veryclean [`c45d2c2`](https://github.com/RCIC-UCI-Public/fileformats-admix/commit/c45d2c250107bbc5a2284d7a3dec0898ec1809fb)
- Add base set. Simplify definitions for hdf5 buidls [`b3e4ff0`](https://github.com/RCIC-UCI-Public/fileformats-admix/commit/b3e4ff0656bf0573d067f57bde1f7cf09a97ce1e)
- Need a specific version of hdf5 built against gcc 8.4.0 for rosetta (in [`f7f89a6`](https://github.com/RCIC-UCI-Public/fileformats-admix/commit/f7f89a6901b61dd77f421df0c8c9548728476d49)
- build hdf5 parallel with openmpi 5.0.1 and gcc 11.2.0 (SET=2024) [`2e9b140`](https://github.com/RCIC-UCI-Public/fileformats-admix/commit/2e9b140c68fef60fb4ecd257ad8f220ba63c81b2)
- add bind mount note [`62fa052`](https://github.com/RCIC-UCI-Public/fileformats-admix/commit/62fa0522de02f56a5b0d360721d21b66f528bd50)
- use bindfs for bind mount (works inside of a singularity container). [`1261f3b`](https://github.com/RCIC-UCI-Public/fileformats-admix/commit/1261f3bb11707e51253e950168c1f0859eac86b3)
- antlr package name adjustments for 9 [`3423c03`](https://github.com/RCIC-UCI-Public/fileformats-admix/commit/3423c03938b78e899c2206de35e9a55f225ce8fd)
- don't build intel2021 set because the intel compiler 2020u1 is not [`aeab577`](https://github.com/RCIC-UCI-Public/fileformats-admix/commit/aeab577f89d53e9b65ab04142595c8c5913c1931)
- add admix name [`6af4f1c`](https://github.com/RCIC-UCI-Public/fileformats-admix/commit/6af4f1cbec002a9226d6d42189022b8e631f2e4c)
- rename sets for clarity [`cf4df26`](https://github.com/RCIC-UCI-Public/fileformats-admix/commit/cf4df2603a62d1cba61122a6f234f401ebd9f485)

## [2.5](https://github.com/RCIC-UCI-Public/fileformats-admix/compare/2.0...2.5) - 2025-01-21

### Commits

- run auto-changelog before tagging [`3219c65`](https://github.com/RCIC-UCI-Public/fileformats-admix/commit/3219c65342496a6c2d2c0f04b9e3d2915576474f)
- use cmake module directly [`861bbc3`](https://github.com/RCIC-UCI-Public/fileformats-admix/commit/861bbc3a99ad491f3a9fa3ddd96f23ec226821c8)
- While fix is pending spell out names in place of using variables. [`0363a56`](https://github.com/RCIC-UCI-Public/fileformats-admix/commit/0363a56282ca311a25270dd3e6176b5377b72472)
- update CHANGELOG [`81cdbc0`](https://github.com/RCIC-UCI-Public/fileformats-admix/commit/81cdbc0e51ecb39eb4b1d96ed038333a2871d8d5)
- restore hdf5 old version compiled with system gcc. [`45ace62`](https://github.com/RCIC-UCI-Public/fileformats-admix/commit/45ace62e4fd47a7b1aceb73e2b34fca311414177)
- redefine some targets in packages to make for easier removal [`180dd93`](https://github.com/RCIC-UCI-Public/fileformats-admix/commit/180dd93ce8e5e1d5d7e511a3f7d772843ebda517)
- specify version for C/Fortran interfaces. Make a separate [`9bf82c9`](https://github.com/RCIC-UCI-Public/fileformats-admix/commit/9bf82c9fbb0411afd5a3aecdd236befe1fe8af9e)
- e regular rpm.extras macro from rpm.yaml [`18267d1`](https://github.com/RCIC-UCI-Public/fileformats-admix/commit/18267d1a67da931819373e48845aa3626bbe007c)
- add auto-changelog generated CHANGELOG.md [`50653ff`](https://github.com/RCIC-UCI-Public/fileformats-admix/commit/50653ff030fb6954b94d8e5e162f7e86ec66440d)
